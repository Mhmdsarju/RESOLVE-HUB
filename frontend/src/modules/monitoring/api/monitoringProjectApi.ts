...
export async function createMonitoringProject(
    data: CreateMonitoringProjectDto,
): Promise<MonitoringProject> {
    const response = await api.post<
        ApiResponse<MonitoringProject>
    >(
...
export async function getMonitoringProjects(
    ...
    const response = await api.get<
        ApiResponse<GetMonitoringProjectsResponse>
    >(
        ENDPOINTS.MONITORING_PROJECT.BASE,
        {
            params,
...
export async function getMonitoringProjectById(
    id: string,
): Promise<MonitoringProject> {
    const response = await api.get<
        ApiResponse<MonitoringProject>
...
export async function deleteMonitoringProject(
    id: string,
): Promise<null> {
