...
export function createSuperAdminOrganizationRoutes(controller: SuperAdminOrganizationController) {
    ...
    router.get("/", authMiddleware,controller.getSuperAdminOrganizations.bind(controller));
    router.get("/analytics", authMiddleware,controller.getOrganizationAnalytics.bind(controller));
    router.get("/revenue-analytics", authMiddleware,controller.getRevenueAnalytics.bind(controller));
    router.get("/payment-history", authMiddleware,controller.getPaymentHistory.bind(controller));
    router.get("/payment-history/export", authMiddleware,controller.exportPaymentReport.bind(controller));
    router.get("/dashboard", authMiddleware,controller.getSuperAdminDashboard.bind(controller));
