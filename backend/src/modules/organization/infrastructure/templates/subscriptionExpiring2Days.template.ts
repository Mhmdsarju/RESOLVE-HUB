export const subscriptionExpiring2DaysTemplate = (organizationName: string, endDate: Date,): string => {
    return `
<!DOCTYPE html>
<html lang="en">
<head>
...
<div style="display:none; max-height:0; overflow:hidden; opacity:0;">
  Your ResolveHub subscription will expire in 2 days.
</div>
...
<p
  ...
  "
>
  Your subscription is about to expire. Please renew it as soon
  as possible to avoid interruption to your ResolveHub services.
</p>
