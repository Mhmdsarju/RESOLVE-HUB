...
<title>ResolveHub - Password Reset Code</title>
</head>
<body style="margin:0; padding:0; background-color:#EDEAE3; font-family: 'Segoe UI', Arial, sans-serif;">

  <!-- Preheader (hidden preview text) -->
  <div style="display:none; max-height:0; overflow:hidden; opacity:0;">
    Your ResolveHub password reset code is inside. Valid for 10 minutes only.
  </div>
        ...
        />
          ...
          <tr>
            <td style="padding:40px 40px 8px 40px;">
              <p style="margin:0 0 6px 0; font-size:15px; color:#4B3932; font-weight:600;">Hi there,</p>
              <p style="margin:0 0 24px 0; font-size:14.5px; line-height:22px; color:#5A4A4A;">
                We received a request to reset the password for your ResolveHub account. Use the verification code below to proceed with resetting your password.
              </p>
            </td>
          </tr>
          ...
          <tr>
            <td style="padding:20px 40px 8px 40px;">
              <p style="margin:0; font-size:12.5px; line-height:19px; color:#A99A90;">
                If you didn't request a password reset, you can safely ignore this email — your password will remain unchanged. For any concerns, contact your ResolveHub admin.
              </p>
            </td>
          </tr>
